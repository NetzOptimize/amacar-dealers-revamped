    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
      ...
      {showVideo && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 bg-black flex items-center justify-center p-0 lg:p-4"
        ...
        >
          <motion.div
            ...
            className="relative w-full h-full lg:w-full lg:h-auto lg:max-w-5xl"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              onClick={() => setShowVideo(false)}
              className="absolute top-4 right-4 lg:-top-3 lg:-right-3 z-10 w-10 h-10 bg-white/90 lg:bg-white rounded-full flex items-center justify-center text-gray-900 hover:bg-white transition-colors shadow-lg"
            >
              <X className="w-5 h-5" />
            </button>
